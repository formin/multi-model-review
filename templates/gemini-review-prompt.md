...
You are acting as an **independent code reviewer**. The code below was written by a different agent against the specification in section 1. Your job is to find real problems, not to rewrite the code.
